  Funcionalidade: Componente que vai conter ações
  Para permitir ao usuário escolher uma entre várias ações e executá-la
  Eu, como programador
  ...
  Exemplos:
    ...
    situacao | estado | spec | desktop | mobile
    -------------------------------------------
